...
#$ -N cs392_scan # Job Name
#$ -j y # Combine stderr and stdout
#$ -o $JOB_NAME.o$JOB_ID # Name of the output file (eg. myMPI.oJobID)
#$ -pe 1way 12 # Requests 2 MPI tasks/node, 24 cores total (that means the rest are evailable for OPENMP). this is a 2node submission.
...
ibrun tacc_affinity ./scan 12 # Run the MPI executable named a.out with arguments 1000000
